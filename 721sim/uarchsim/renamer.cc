...
//-------------------------------------------------------------------
	...
	uint64_t renamer:: rename_rdst(uint64_t log_reg){
        ...
        // Check for confident prediction for the logical destination register
        // uint64_t predicted_value;
        // bool prediction_available = get_confident_prediction(log_reg, predicted_value);
        ...
        if(freelist.head == freelist.size){
         ...
         // If there is a confident prediction, write the predicted value to the physical register file and update its ready bit
        // if (prediction_available) {
        //     write(physical_register, predicted_value);
        //     set_ready(physical_register);
        // }
